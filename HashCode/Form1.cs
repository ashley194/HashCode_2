...
namespace HashCode
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (!hashCodeGenerator.generatorValid)
            {
                MessageBox.Show("Invalid sort codes or payment value");

                return;
            }

            string output = "" + hashCodeGenerator.SHA256().ToString();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (Proceed("Have you completed all fields above?", "Compare"))
            {
                ...
                {
                    MessageBox.Show("Hash Codes do not match!", "Please try Again", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
            }
        }
        ...
        {
            if (txtRandomString.Text == textBox5.Text)
